...
const (
	defaultMrklPrefix = `Today is {{.today}}.
Answer the following questions as best you can. You have access to the following tools:

{{.tool_descriptions}}`

	defaultMrklFormatInstructions = `Use the following format:
...
func toolNames(tools []llm.AgentTool) string {
...
func toolDescriptions(tools []llm.AgentTool) string {
